...
class Weibo(object):
                    ...
                    if w['card_type'] == 9:
                        ...
                        if wb:
                            if (not self.filter) or (
                                ...
                                print(wb['created_at'])
                                if((wb['created_at'].strip() == '2017-12-30'.strip())
                                or (wb['created_at'].strip() == '2017-12-29'.strip())):
                                    exit()


                                if ((wb['created_at'].strip() == '2018-06-04'.strip())
                                or (wb['created_at'].strip() == '2018-09-04'.strip())
                                        or (wb['created_at'].strip() == '2018-11-14'.strip())
                                        or (wb['created_at'].strip() == '2018-02-15'.strip())
                                        or (wb['created_at'].strip() == '2018-10-26'.strip())
                                        or (wb['created_at'].strip() == '2018-04-28'.strip())
                                        or (wb['created_at'].strip() == '2018-05-05'.strip())
                                        or (wb['created_at'].strip() == '2018-07-02'.strip())
                                        or (wb['created_at'].strip() == '2018-10-02'.strip())
                                        or (wb['created_at'].strip() == '2018-05-16'.strip())
                                        or (wb['created_at'].strip() == '2018-08-23'.strip())
                                        or (wb['created_at'].strip() == '2018-11-16'.strip())
                                        or (wb['created_at'].strip() == '2018-12-01'.strip())
                                        or (wb['created_at'].strip() == '2018-09-09'.strip())
                                ):
    ...
    def get_pages(self):
        ...
        for page in tqdm(range(900, page_count + 1), desc=u"进度"):
            print(u'第%d页' % page)
...
def main():
    try:
        # user_id = 2418724427  # 可以改成任意合法的用户id   北京发布
        # user_id = 2539961154  # 可以改成任意合法的用户id   上海发布
        # user_id = 2239082677   # 青岛发布
        user_id = 1523766213     #成都发布
